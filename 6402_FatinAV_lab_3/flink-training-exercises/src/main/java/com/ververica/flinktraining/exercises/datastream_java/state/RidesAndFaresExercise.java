...
public class RidesAndFaresExercise extends ExerciseBase {
	...
	public static class EnrichmentFunction extends RichCoFlatMapFunction<TaxiRide, TaxiFare, Tuple2<TaxiRide, TaxiFare>> {
		...
		public void open(Configuration config) {
			ValueStateDescriptor<TaxiRide> rideDescriptor = new ValueStateDescriptor<>("savedRide", TaxiRide.class);
			rideState = getRuntimeContext().getState(rideDescriptor);

			ValueStateDescriptor<TaxiFare> fareDescriptor = new ValueStateDescriptor<>("savedFare", TaxiFare.class);
